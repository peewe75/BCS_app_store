    ...
    contents: {
      parts: [
        ...
        },
        {
          ...
          **Instructions:**
          1. Describe a short 5-second video movement that fits the '${ugcStyle}' style (e.g., handheld shake for 'POV', smooth pan for 'Cinematic', quick zoom for 'TikTok').
          2. Describe the motion of elements in the scene (e.g., light leaks, wind, user interaction).
          3. **AUDIO / SPEECH:** This is critical. The prompt must explicitly request that the video includes audio. If there are people or voiceovers, they **MUST SPEAK IN ${language}**.
             - Example instruction to add to prompt: "The audio should feature an enthusiastic voiceover in ${language} describing the product."

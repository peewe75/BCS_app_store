...
import type { TaxResults } from '@/src/apps/trading/report-engine'
import type {
...
function drawRtSection(
  ...
  drawGridTable(
    ...
    y + 24,
    [
      { title: 'Rigo', width: 74, align: 'center' as const },
      { title: 'Descrizione', width: 292, align: 'left' as const },
      { title: 'Importo', width: 146, align: 'right' as const },
    ],
    rows
  )
...
function drawRwSection(
  ...
  drawGridTable(
    ...
    y + 24,
    [
      { title: 'Campo', width: 196, align: 'left' as const },
      { title: 'Valore', width: 146, align: 'right' as const },
      { title: 'Nota', width: 170, align: 'left' as const },
    ],
    rows
  )
...
function drawFieldSourcesSection(
  ...
  drawGridTable(
    ...
    y + 24,
    [
      { title: 'Campo', width: 210, align: 'left' as const },
      { title: 'Origine', width: 120, align: 'left' as const },
      { title: 'Nota', width: 182, align: 'left' as const },
    ],
    rows
  )
}
...
function drawKeyValueTable(doc: PDFKit.PDFDocument, startY: number, rows: string[][]) {
  drawGridTable(
    ...
    startY,
    [
      { title: 'Campo', width: 180, align: 'left' as const },
      { title: 'Valore', width: 210, align: 'left' as const },
      { title: 'Origine', width: 122, align: 'left' as const },
    ],
    rows
  )
}
